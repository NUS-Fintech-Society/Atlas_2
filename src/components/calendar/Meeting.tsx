...
export default function Meeting({meeting}: meeting) {
    ...
    return (
      <li className="flex items-center px-4 py-2 space-x-4 group rounded-xl focus-within:bg-green-400 hover:bg-green-400">
              ...
              <div className="py-1">
                <Menu.Item>
                  {({ active }) => (
                    <button
                      className={
                        combineClasses(['block px-4 py-2 text-sm'].concat(
